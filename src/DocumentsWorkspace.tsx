...
type Props = { documents: WorkspaceDocument[]; onCreate: () => void; onUpdate: (id: string | number, patch: Partial<WorkspaceDocument>) => void; savingIds?: (string | number)[] };

export function DocumentsWorkspace({ documents, onCreate, onUpdate, savingIds = [] }: Props) {
