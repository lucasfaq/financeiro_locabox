...
describe("toRemoteTask", () => {
  it("transforma os códigos financeiros do banco no modelo exibido", () => {
    expect(toRemoteTask({ id: "a1", titulo: "Conferir retenções", valor_previsto: "12800.50", inicio: "2026-08-01", vencimento: "2026-08-04", prioridade: "alta", status: "em_aprovacao", responsavel_id: "user-1", lista_id: "lista-1", tipo: "financeiro", empresa_id: "empresa-1" }, "Locabox")).toMatchObject({ id: "a1", title: "Conferir retenções", company: "Locabox", start: "01/08/2026", due: "04/08/2026", value: 12800.5, priority: "Alta", status: "Em aprovação", owner: "Responsável da equipe", listId: "lista-1", taskType: "Financeiro" });
  });
